      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-header bg-primary">
            ...
            <p>
              <?php echo $this->session->userdata('namaq'); ?> - <?php if ($this->session->userdata('roleq') == 0) {echo "Admin";} else { echo "Pegawai";} ?>
            </p>
          </li>
          <!-- Menu Footer-->
        ...
        <!-- <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"> -->
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/randomtampil_bagasi2" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP I (ISLAND II)</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/verifikasi_rcscp2_tampil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP II</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/verifikasi_rcscptransit_tampil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP Transit</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/verifikasi_rcscpinter_tampil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP Internasional</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/verifikasi_rcscpkaryawan_tampil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP Akses Karyawan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/verifikasi_rcscppos2_tampil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP POS Ops II</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url(); ?>main/verifikasi_rcbagasi2_tampil" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SCP I (ISLAND II)</p>
                </a>
              </li>
