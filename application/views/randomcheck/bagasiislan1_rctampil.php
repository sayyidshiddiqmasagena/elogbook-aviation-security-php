<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-12">
            <h4>RANDOM CHECK & UNPREDICTIBLE BAGASI TERCATAT DI SCP I (ISLAND I)</h4>
          </div><!-- 
          <div class="col-sm-6">
                ...
                <!-- <div class="row">                   -->
                  <div class="row">                    
                    ...
                    <div class="col-sm-2 float-right">
                      <form action="<?php base_url(); ?>random_bagasi1" method="POST">                    
                ...
                <table id="example4" class="table table-striped projects table-bordered display no-wrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a class="m-1 btn btn-warning btn-sm approval" href="<?php base_url(); ?>randomedit_bagasiislan1?idno=<?php echo $idno ?>" method="POST" title="Edit">
                        <i class="fas fa-pen"></i>
                      </a>

                      <a class="m-1 btn btn-danger btn-sm delete" href="<?php base_url(); ?>random_delete_bagasiislan1?idno=<?php echo $idno ?>" title="Hapus">
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="POST" action="<?php base_url();?>approvform_insert">
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">                      
                <input class="form-control" type="text" name="lokasi" value="SCP I (ISLAND I)">  
              </div>
            </div>
