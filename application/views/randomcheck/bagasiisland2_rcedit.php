          ...
          <div class="col-md-4">            
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Form Random Check di SCP I (ISLAND II)</h3>
              </div>
              <form method="POST" action="<?php base_url();?>random_update_bagasiisland2" enctype="multipart/form-data">
              <div class="center_div">
                ...
                ?>
                  ...
                  <div class="form-group">
                    <label>Jam</label>
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control" type="hidden" name="lokasi" value="SCP I (ISLAND II)">

                  <div class="form-group">
                    <label>Nama Pemilik</label>
                    <input class="form-control" type="text" name="namapax" value="<?php echo $rw->namapemilik?>" required>
                  ...
                  <div class="form-group">
                      <label>Jenis Bagasi</label>                      
                      <input class="form-control" type="text" name="jenisbrg_bawaan" value="<?php echo $rw->jns_bagasi?>" required>
                  </div>
                  
                  <div class="form-group">                    
                      <label>Nomor Claim Bagasi</label>  
                      <input class="form-control" type="text" name="no_claim" onkeypress="return isNumberKey(event)" value="<?php echo $rw->no_claim?>" required>  
                  </div>

                  <div class="form-group">                    
                    <label>Metode Pemeriksaan Bagasi</label>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" value="0" name="mtdperiksabrg"
                      <?php if ($rw->mtd_periksabagasi == 0) 
                        echo "checked";
                      ?>>
              ...
              ?>
                  ...
                  <div class="card-footer">
                      ...
                      <button class="btn btn-danger float-right" href="<?= base_url(); ?>main/randomtampil_bagasi1" >Cancel</button>
                  </div>                  
                </div>
              </div>
              </form>
