<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-12">
            <h4>RANDOM CHECK & UNPREDICTIBLE BAGASI TERCATAT DI SCP I (ISLAND II)</h4>
          </div><!-- 
          <div class="col-sm-6">
    ...
    <?php 
      ...
      $tgl = date('d-m-Y', strtotime($this->session->userdata('tglrdbagasi')));
      $team = $this->session->userdata('teamrdbagasi');
      $shift = $this->session->userdata('shiftrdbagasi');
    ?>
          ...
          <!-- <div class="col-12"> -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-12">
                  <form class="form-horizontal" action="<?php base_url(); ?>randomtampil_bagasi2" method="POST">
                    <div class="form-group row">
                      <div class="col-sm-2">
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">                            
                          ...
                          <input type="text" name="tglcari_rdbagasi" class="form-control datetimepicker-input" data-target="#reservationdate"  value="<?php if ($tgl == NULL ) { echo ""; } else { echo $tgl;} ?>"/>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-2">
                        <select class="form-control" name="team" style="width: 100%;">
                          ...
                          <option <?php if ($team == "ALPHA") {echo "selected";} else {echo "";} ?> value="ALPHA">ALPHA</option>
                          <option <?php if ($team == "BRAVO") {echo "selected";} else {echo "";} ?> value="BRAVO">BRAVO</option>
                          <option <?php if ($team == "CHARLIE") {echo "selected";} else {echo "";} ?> value="CHARLIE">CHARLIE</option>
                          <option <?php if ($team == "DELTA") {echo "selected";} else {echo "";} ?> value="DELTA">DELTA</option>
                          <option <?php if ($team == "ECHO") {echo "selected";} else {echo "";} ?> value="ECHO">ECHO</option>
                        </select>
                      </div>
                      ...
                      <div class="col-sm-2">
                        <select class="form-control" name="shift" style="width: 100%;">
                          ...
                          <option <?php if ($shift == "PAGI") {echo "selected";} else {echo "";} ?> value="PAGI">PAGI</option>
                          <option <?php if ($shift == "SIANG") {echo "selected";} else {echo "";} ?> value="SIANG">SIANG</option>
                          <option <?php if ($shift == "MALAM") {echo "selected";} else {echo "";} ?> value="MALAM">MALAM</option>
                        </select>
                      </div>

                      <div class="col-sm-1">
                        <button type="submit" class="btn btn-secondary btn btn-block" name="rdbagasi"> Cari! </button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <!-- <div class="row">                   -->
                  <div class="row">                    
                    ...
                    <div class="col-sm-2 float-right">
                      <form action="<?php base_url(); ?>random_bagasi2" method="POST">                    
                ...
                <table id="example4" class="table table-striped projects table-bordered display no-wrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a class="m-1 btn btn-warning btn-sm approval" href="<?php base_url(); ?>randomedit_bagasiisland2?idno=<?php echo $idno ?>" method="POST" title="Edit">
                        <i class="fas fa-pen"></i>
                      </a>

                      <a class="m-1 btn btn-danger btn-sm delete" href="<?php base_url(); ?>random_delete_bagasiisland2?idno=<?php echo $idno ?>" title="Hapus">
                        <i class="far fa-trash-alt"></i>
                      </a>

                      <a class="m-1 btn btn-success btn-sm print" href="<?php base_url(); ?>print_bagasi2?idkode=<?php echo $idkode ?>" rel="noopener" target="_blank" title="Print">
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="POST" action="<?php base_url();?>approvform_insert_bagasi2">
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">                      
                <input class="form-control" type="text" name="lokasi" value="SCP I (ISLAND II)">  
              </div>
            </div>
