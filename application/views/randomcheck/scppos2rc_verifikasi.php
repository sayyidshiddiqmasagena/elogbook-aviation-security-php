<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-12">
            <h4>VERIFIKASI RANDOM CHECK & UNPREDICTIBLE ORANG DAN BARANG DI SCP POS OPERASIONAL 2</h4>
          </div><!-- 
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <!-- <form> -->
                  <div class="row">
                    <div class="col-sm-3">
                      <form action="<?php base_url(); ?>randomorang_scppos2_search" method="POST">
                    ...
                    <div class="col-sm-4">
                      <form action="<?php base_url(); ?>randomtampil_scppos2" method="POST">                    
                ...
                <a href="<?php base_url(); ?>print_scppos2" rel="noopener" target="_blank" class="btn btn-primary"><i class="fas fa-print"></i> Print</a>
                ...
                <!-- <table id="example1" class="table table-bordered table-striped table-hover"> -->
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="m-1 btn btn-info btn-sm openPopup" href="javascript:void(0);" data-href="<?php base_url()?>randomtabel_scppos2?idkode=<?php echo $idkode ?>" title="Lihat">
                         ...
                         <!--  <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-approval" title="Konfirmasi">
                          ...
                          <a class="m-1 btn btn-warning btn-sm approval" href="javascript:void(0);" data-href="<?php base_url()?>rcscppos2_konfirm?idkode=<?php echo $idkode ?>">
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">VERIFIKASI RANDOM CHECK & UNPREDICTIBLE ORANG DAN BARANG DI SCP POS OPERASIONAL 2</h4>
