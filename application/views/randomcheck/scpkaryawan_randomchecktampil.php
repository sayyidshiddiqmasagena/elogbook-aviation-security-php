<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-12">
            <h4>RANDOM CHECK & UNPREDICTIBLE ORANG & BARANG DI SCP AKSES KARYAWAN</h4>
          </div><!-- 
          <div class="col-sm-6">
          ...
          <!-- <div class="col-12"> -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-12">
                  <form class="form-horizontal" action="<?php base_url(); ?>randomtampil_scpkaryawan" method="POST">
                ...
                <!-- <div class="row">                   -->
                  <div class="row">                    
                    ...
                    <div class="col-sm-2 float-right">
                      <form action="<?php base_url(); ?>random_scpkaryawan" method="POST">                    
                  ...
                  <tbody>
                    ...
                    <tr>
                      <!-- idno, tanggal, , nopen, , , , personil_pemeriksa, hasil_temuan, lokasi, jam_periksa -->
                        ...
                        <td><?php echo $data->namakar; ?></td>
                        <td style="text-align: center"><?php echo $data->instansi; ?></td>
                        <td><?php echo $data->jenisbrg_bawaan; ?></td>
                                                
                        <td style="text-align: center"><?php if ($data->mtd_periksakar==0) echo " &radic;"; else echo "-"; ?></td>
                      ...
                      <a class="m-1 btn btn-warning btn-sm approval" href="<?php base_url(); ?>randomedit_scpkaryawan?idno=<?php echo $idno ?>" method="POST" title="Edit">
                        <i class="fas fa-pen"></i>
                      </a>

                      <a class="m-1 btn btn-danger btn-sm delete" href="<?php base_url(); ?>random_delete_scpkaryawan?idno=<?php echo $idno ?>" title="Hapus">
                        <i class="far fa-trash-alt"></i>
                      </a>

                      <a class="m-1 btn btn-success btn-sm print" href="<?php base_url(); ?>print_scpkaryawan?idkode=<?php echo $idkode ?>" rel="noopener" target="_blank" title="Print">
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="POST" action="<?php base_url();?>approvform_scpkaryawan_insert">
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">                      
                <input class="form-control" type="text" name="lokasi" value="SCP KARYAWAN">  
              </div>
            </div>
