<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-12">
            <h4>VERIFIKASI RANDOM CHECK & UNPREDICTIBLE ORANG DAN BARANG DI SCP AKSES KARYAWAN</h4>
          </div><!-- 
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                <!-- <form> -->
                  <div class="row">
                    <div class="col-sm-3">
                      <form action="<?php base_url(); ?>randomorang_karyawan_search" method="POST">
                    ...
                    <div class="col-sm-4">
                      <form action="<?php base_url(); ?>randomtampil_scpkaryawan" method="POST">                    
                ...
                <a href="<?php base_url(); ?>print_scpkaryawan" rel="noopener" target="_blank" class="btn btn-primary"><i class="fas fa-print"></i> Print</a>
              ...
              <div class="card-body">
                <!-- <table id="example1" class="table table-bordered table-striped table-hover"> -->
                  ...
                  <tbody>
                      ...
                      $nourut=1;
                      foreach ($ver_rcscpkaryawan as $data) {                    
                    ...
                    <tr>
                        ...
                        <td>
                          <a class="m-1 btn btn-info btn-sm openPopup" href="javascript:void(0);" data-href="<?php base_url()?>randomtabel_scpkaryawan?idkode=<?php echo $idkode ?>" title="Lihat">
                         ...
                         <!--  <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-approval" title="Konfirmasi">
                          ...
                          <a class="m-1 btn btn-warning btn-sm approval" href="javascript:void(0);" data-href="<?php base_url()?>rcscpkaryawan_konfirm?idkode=<?php echo $idkode ?>">
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">VERIFIKASI RANDOM CHECK & UNPREDICTIBLE ORANG DAN BARANG DI SCP AKSES KARYAWAN</h4>
