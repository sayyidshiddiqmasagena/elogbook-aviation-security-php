          ...
          <!-- <div class="col-12"> -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-12">
                  <form class="form-horizontal" action="<?php base_url(); ?>randomtampil_scppos2" method="POST">
                ...
                <!-- <div class="row">                   -->
                  <div class="row">                    
                    ...
                    <div class="col-sm-2 float-right">
                      <form action="<?php base_url(); ?>random_scppos2" method="POST">                    
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="POST" action="<?php base_url();?>approvform_scppos2_insert">
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">                      
                <input class="form-control" type="text" name="lokasi" value="SCP POS OPERASIONAL 2">  
              </div>
            </div>
