        ...
        <div class="row">
          <div class="col-md-4">            
            <div class="card card-info">
              ...
              <form method="POST" action="<?php base_url();?>randombagasi2_insert" enctype="multipart/form-data">
              <div class="center_div">
                <div class="card-body">
                  ...
                  <div class="form-group">                    
                      ...
                      <input class="form-control" type="text" name="no_claim" onkeypress="return isNumberKey(event)" required>  
                  </div>
