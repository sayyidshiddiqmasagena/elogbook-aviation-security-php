        ...
        <div class="col-md-4">
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Form Edit Random Check di SCP INTERNASIONAL</h3>
            </div>
            <form method="POST" action="<?php base_url();  ?>random_update_scpinter" enctype="multipart/form-data">
              <div class="center_div">
                ...
                ?>
                  ...
                  <input class="form-control" type="hidden" name="lokasi" value="SCP INTERNASIONAL">
              ...
              ?>
                  ...
                  <div class="card-footer">
                    ...
                    <button class="btn btn-danger float-right" href="<?= base_url(); ?>main/randomtampil_scpinter" >Cancel</button>
                  </div>
                </div>
              </div>
            </form>
