          ...
          <div class="col-md-4">            
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Form Random Check di SCP AKSES KARYAWAN</h3>
              </div>
              <form method="POST" action="<?php base_url();?>random_insert_scpkaryawan" enctype="multipart/form-data">
              <div class="center_div">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Jam</label>
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control" type="hidden" name="lokasi" value="SCP KARYAWAN">
                    ...
                    ?>
                    <input class="form-control" type="text" name="namakar" required>
                  </div>
                  ...
                  <div class="form-group">                    
                      ...
                      ?>
                        <input class="form-control" type="text" name="instansi" maxlength="10" onkeyup="this.value = this.value.toUpperCase();" required>                      
                  </div>
                  ...
                  <div class="form-group">                    
                      <label>Metode Pemeriksaan Penumpang</label>                      
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="0" name="mtdperiksakar" checked>
