          ...
          <div class="col-md-4">            
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Form Random Check di SCP I (ISLAND I)</h3>
              </div>
              <form method="POST" action="<?php base_url();?>random_update_bagasiislan1" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label>Jam</label>
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control" type="hidden" name="lokasi" value="SCP I (ISLAND I)">
