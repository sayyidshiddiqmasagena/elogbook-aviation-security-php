<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-12">
            <h4>RANDOM CHECK & UNPREDICTIBLE ORANG & BARANG DI SCP INTERNASIONAL</h4>
          </div><!-- 
          <div class="col-sm-6">
          ...
          <!-- <div class="col-12"> -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="col-12">
                  <form class="form-horizontal" action="<?php base_url(); ?>randomtampil_scpinter" method="POST">
                ...
                <!-- <div class="row">                   -->
                  <div class="row">                    
                    ...
                    <div class="col-sm-2 float-right">
                      <form action="<?php base_url(); ?>random_scpinter" method="POST">                    
                ...
                <table id="example4" class="table table-striped projects table-bordered display no-wrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a class="m-1 btn btn-warning btn-sm approval" href="<?php base_url(); ?>randomedit_scpinter?idno=<?php echo $idno ?>" method="POST" title="Edit">
                        <i class="fas fa-pen"></i>
                      </a>

                      <a class="m-1 btn btn-danger btn-sm delete" href="<?php base_url(); ?>random_delete_scpinter?idno=<?php echo $idno ?>" title="Hapus">
                        <i class="far fa-trash-alt"></i>
                      </a>

                      <a class="m-1 btn btn-success btn-sm print" href="<?php base_url(); ?>print_scpinter?idkode=<?php echo $idkode ?>" rel="noopener" target="_blank" title="Print">
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="POST" action="<?php base_url();?>approvform_scpinter_insert">
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">                      
                <input class="form-control" type="text" name="lokasi" value="SCP INTERNASIONAL">  
              </div>
            </div>
